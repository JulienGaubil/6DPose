...
def calc_3d_bbox(xs, ys, zs):
    ...
    Input : 
        - xs: 1D ndarray with x-coordinates of 3D points.
        - ys: 1D ndarray with y-coordinates of 3D points.
        - zs: 1D ndarray with z-coordinates of 3D points.
    Output : 
        - liste à 6 éléments, contient la bounding box 3D de l'objet, (x, y, z, w, h, d), où (x, y, z) est le coin haut-gauche, et (w, h, d) est la largeur, hauteur et 
            profondeur de la bounding box.
    """
